...
describe('en.json / fr.json — key-set parity', () => {
  ...
  it('both locale files declare exactly the same key count, pinned to the current key-complete baseline', () => {
    ...
    // Baseline is now 3484 (up from 3476): #1009 adds 8 keys for the
    // ground-levelling order feature — ui.crew.action_level_ground,
    // ui.build.level_ground, ui.build.level_ground_ordered,
    ...
    // hint) — both locales.
    // Baseline is now 3514 (up from 3512): #1181 adds
