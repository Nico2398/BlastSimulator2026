...
const SERIALIZED_FIELDS = [
  ...
  'sequencedCount', 'surveyCount', 'pendingActionCount', 'buildingCount', 'vehicleCount',
  'hasStockedOreSaleOffer', 'sitePolicyShiftMode', 'sitePolicyFatigueThreshold', 'employeeCount',
