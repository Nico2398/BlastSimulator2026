...
description: >
  Agentic code duplication reviewer. Detects semantic duplication, non-atomic functions,
  generic code misplaced in specific modules, and cross-codebase logic similarities. Read-only.
