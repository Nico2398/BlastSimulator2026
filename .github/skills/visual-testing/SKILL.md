...
- `PUPPETEER_EXECUTABLE_PATH` may vary. For agent sandbox: `/usr/bin/chromium`
...
Never mark a rendering task complete unless:
1. A screenshot confirms geometry is visible and correct
