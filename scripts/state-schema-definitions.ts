...
export const GAME_STATE_SCHEMA: Schema = {
  ...
  hasStockedOreSaleOffer: { type: 'boolean', description: 'An offered ore_sale contract asks for a material the site currently holds' },
  sitePolicyShiftMode: { type: 'string', description: 'Active shift mode (SitePolicy.shiftMode)' },
  sitePolicyFatigueThreshold: { type: 'number', description: 'Active fatigue rest threshold, 0-100' },
