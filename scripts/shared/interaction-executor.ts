...
// Console commands a `bootstrap`-marked step may run (issue #515) — moved to
// its own module (#557) since this file is already over the 300-line budget
// and grandfathered at its own baseline (may only shrink). Re-exported here
// so existing `import { BOOTSTRAP_COMMAND_ALLOWLIST } from './interaction-executor.js'`
// call sites keep working.
export { BOOTSTRAP_COMMAND_ALLOWLIST } from './bootstrap-allowlist.js';
import { BOOTSTRAP_COMMAND_ALLOWLIST } from './bootstrap-allowlist.js';
