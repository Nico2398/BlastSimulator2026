...
description: Audits context files after pipeline changes. Checks if any context file (skills, agent definitions, prompts) needs updates and validates them against agentic-context-edition principles.
mode: primary
permission:
  bash:
    "*": "allow"
