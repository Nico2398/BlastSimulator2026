...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    isComplete: (s) => s.surveyResults.length > 0,
  },
  {
    id: 'drill',
    ...
    commands: ['drill plan'],
    isComplete: (s) => s.drillHoles.length > 0,
  },
  {
    id: 'charge',
  ...
  },
  {
    ...
    commands: ['contracts'],
    isComplete: (s) => s.contracts.active.length > 0,
  },
  {
    id: 'sell-ore',
    titleKey: 'tutorial.step7.title',
    textKey: 'tutorial.step7',
    isComplete: (s) => s.cash > 0,
  },
  {
  ...
  },
  {
    ...
    commands: ['research'],
    isComplete: (s) => s.buildings.researchQueue.length > 0,
  },
  {
    id: 'upgrade',
