...
Provides direct Python functions for non-agentic node use and agents:
  - github_create_pr    used by open_pr node directly (non-agentic)
  - github_post_comment available to agents (reviewer)
