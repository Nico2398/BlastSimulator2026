...
def _build_deepseek(model_name: str):
    ...
    # max_retries=0: fail fast on hang/timeout; pipeline has its own retry logic
    return ChatDeepSeek(model=model_name, api_key=api_key, timeout=timeout, max_retries=0)
