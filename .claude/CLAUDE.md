...
CLAUDE.md, agent definitions, and skills all use this convention. Two kinds of content. Obey their rules:
...
Skills in `.claude/skills/` auto-load based on task relevance. Prefix categories:
